  ...
  public tasks = [
    {
      title: 'Einstellungen',
      subTasks: [
        { cssClass: 'danger', title: 'Set Page Title, favicon, logo, description' },
        { cssClass: 'warning', title: 'Set password to frontend page' },
        { cssClass: 'danger', title: 'Add Facebook, Twitter, Instagram, Youtube infos' }
      ]
    },
    {
      title: 'Verein',
      subTasks: [
        ...
        { cssClass: 'warning', title: 'Vorstandspositionen sortieren (up/down)' },
